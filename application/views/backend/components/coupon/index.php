								...
								<table class="table table-hover table-bordered">
									<thead>
										<tr>
											...
											<th class="text-center">Sử dụng giảm giá theo phần trăm</th>
									...
									<?php foreach ($list as $row):?>
										<tr>
											...
											<td><?php
											if ($row['use_discount_percent'] == "1") {
    											echo '<input type="checkbox" disabled name="use_discount_percent" checked value="True">';
											} else {
    											echo '<input type="checkbox" disabled name="use_discount_percent" value="True">';
											}
											?></td>
											...
											<td class="text-center">
												...
												if($user['role']==1){
													...
													echo '<p class="fa fa-lock" style="color:red"></p>';
												}
												?>
											</td>
											<td class="text-center">
												<a class="btn btn-danger btn-xs" href="admin/coupon/trash/<?php echo $row['id'] ?>"  onclick="return confirm('Xác nhận Xóa Mã giảm giá này ?')" role = "button">
