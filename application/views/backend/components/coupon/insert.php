...
<div class="content-wrapper">
	<form action="<?php echo base_url() ?>admin/coupon/insert.php" enctype="multipart/form-data" method="POST" accept-charset="utf-8">
						...
						<div class="box-body">
							<div class="col-md-6">
								...
								<div class="form-group">
									...
									<input type="number" min="1" max="100" class="form-control" name="discount_percent" style="width:100%" placeholder="Phần trăm giảm giá giảm giá">
								</div>
								<!-- Loại hình giảm giá -->
								<div class="form-group">
									<label>Sử dụng giảm giá theo phần trăm</label>
									<input type="checkbox" name="use_discount_percent" value="True">
								</div>
