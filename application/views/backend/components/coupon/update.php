						...
						<div class="box-body">
							<div class="col-md-6">
								...
								<div class="form-group">
									...
									<input type="number" min="1" max="100" class="form-control" name="discount_percent" style="width:100%" placeholder="Phần trăm giảm giá giảm giá" value="<?php echo $row['discount_percent'] ?>">
								</div>
								<!-- Loại hình giảm giá -->
								<div class="form-group">
									<label>Sử dụng giảm giá theo phần trăm</label>
									<?php
									if ($row['use_discount_percent'] == "1") {
    									echo '<input type="checkbox" name="use_discount_percent" checked value="True">';
									} else {
    									echo '<input type="checkbox" name="use_discount_percent" value="True">';
									}
									?>
								</div>
								<div class="form-group">
