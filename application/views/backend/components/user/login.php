<html lang="">
    ...
    <body>
        <div class="container khung">
            ...
            <hr>
            <div class="myform">
                <form name="form1" action="admin/user/login.php" method="post" role="form">
        ...
        <nav class="navbar navbar-fixed-bottom" role="navigation">
            <div class="container">
               <h5 class="text-center">Copyright © 2024 <a href="#" style="color:red">Smart-Store</a>. All rights reserved.</h5>
            </div>
        </nav>
        <!-- jQuery -->
