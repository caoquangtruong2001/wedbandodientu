<div class="row content-cart">
	<div class="container">
		<?php if($this->session->userdata('cart')):
			...
			<!--<form onsubmit="return confirm('Xác nhận thanh toán')" method="POST" actione="<?php echo base_url('online-checkout') ?>">
										<td colspan="2">
												<button type="submit"  name="payUrl"  class="btn-next-checkout">MOMO</button>
										</td>
										<tr>

											<td colspan="2">
												<button type="button" name="vnpay" onclick="window.location.href='online-checkout'" class="btn-next-checkout">VNPAY</button>
											</td>
			</form> -->
			<?php else: ?>
				<div class="cart-info">
