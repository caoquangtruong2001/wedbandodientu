<?php echo form_open('info-ordermomo'); ?>
<?php  
if(!$this->session->userdata('cart')){
    redirect('online-checkout');
}else{
    ...
    <div class="container">
        <div class="col-md-12">
            <div class="wrapper overflow-hidden">
                <form action="<?php echo base_url('online-checkout') ?> "  method="POST" accept-charset="utf-8" >
                   <?php
                    ...
                    <div class="wrap-info" style="width: 100%; min-height: 1px; overflow: hidden; padding: 10px;">
                        <table class="table tinfo" style="width: 80%;">
                            <tbody>
                                ...
                                <form action="<?php echo base_url('online-checkout') ?> "  method="POST" accept-charset="utf-8" name="payUrl">
                            <tr>
                                <td style="border: none;"></td>
                                <td style="border: none;"><div class="btn-checkout frame-100-1 overflow-hidden border-pri" style="float: right;">
                                    <button type="submit"  style="width: 300px" class="bg-pri border-pri col-fff" name="payUrl">Thanh toán MOMO</button></td>
                                </tr>
                                            </form>
                            </tbody>
                        </table>
                    ...
                    <table class="table" style="color: #333">
                        <tbody>
                         ...
                         if($this->session->userdata('coupon_price')){
                            ...
                            $price_coupon_percent = $this->session->userdata('coupon_percent');
                            $is_percent_coupon = $this->session->userdata('is_percent_coupon');
                            
                            $coupon = "";

                            if(isset($is_percent_coupon) && $is_percent_coupon == 1){
                        ...
                        <tr style="background: #f4f4f4">
                            ...
                            <td class="text-center">
                                <p style="font-size: 15px; color: red;">
                                 ...
                                 {
                                    if(isset($is_percent_coupon) && $is_percent_coupon == 1){
                                        $money_pay = $money - $money * $price_coupon_percent / 100 + $this->Mconfig->config_price_ship();
                                    }else{
